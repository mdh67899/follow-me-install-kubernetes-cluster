...
注意: 如果您的内核版本太低，运行1.16.0版本的kubelet会有问题，kubelet根本无法工作，centos 7.x版本的3.10.0-514.6.1.el7.x86_64内核版本太低，强烈建议您使用centos最新版本来部署，如果是旧系统，请使用yum方式来升级内核，或者直接按照下文直接升级内核到4.4.x
```bashrc
yum update kernel
```
